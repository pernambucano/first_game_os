...
#import "ScoreResultsViewController.h"

@interface ScoreResultsViewController () {
    NSArray *scores;
}

@end

@implementation ScoreResultsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self loadAndSortScores];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *data = scores[indexPath.row];
